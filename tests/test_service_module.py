...
SERVICE_MODULES_FOR_TEST = {
    ...
    'sctg': (CaptchaType.IMAGE, CaptchaType.TEXT, CaptchaType.RECAPTCHAV2,
             CaptchaType.RECAPTCHAV3, CaptchaType.FUNCAPTCHA, CaptchaType.KEYCAPTCHA,
             CaptchaType.GEETEST, CaptchaType.GEETESTV4, CaptchaType.HCAPTCHA,
             CaptchaType.CAPY, CaptchaType.TIKTOK, CaptchaType.TURNSTILE),
    'multibot': (CaptchaType.RECAPTCHAV2, CaptchaType.RECAPTCHAV3,
